...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}],[\"es2015\",{\"modules\":false}]],\"plugins\":[\"transform-object-rest-spread\",[\"component\",[{\"libraryName\":\"element-ui\",\"styleLibraryName\":\"theme-chalk\"}]]]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/admin/problems.vue":
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        setProblems: function setProblems(cp) {
            ...
            axios.get('/admin/problems?page=' + cp).then(function (response) {
            ...
            _c(
              ...
              [
                ...
                _vm._l(_vm.problems, function(problem) {
                  return _c("tr", [
                    _c("td", [_vm._v(_vm._s(problem.problem_id))]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(problem.title))]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(problem.user_name))]),
                    _vm._v(" "),
