...
(function () {
    ...
    var ture_url = window.location.protocol + "//" + window.location.hostname + (window.location.port ? ':' + window.location.port: '');
    /**
    ...
    window.UMEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:ture_url+"/addproblemimage"             //图片上传提交地址
        ,imagePath:ture_url + "/problemImage/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
